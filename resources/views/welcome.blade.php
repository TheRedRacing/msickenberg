    ...
    <body class="scroll-smooth">
        ...
        <header class="fixed left-0 right-0 top-0 z-30 flex flex-col justify-center items-center w-full py-2 bg-white bg-opacity-70 backdrop-blur border-b border-zinc-200">         
            ...
            <div class="flex justify-center items-center">
                ...
                <a class="buttonAbout w-20 text-zinc-700 flex justify-center items-center gap-2 py-2 hover:bg-blue-100 rounded-md cursor-pointer">
                    About
                </a>
            </div>
                ...
                <div class="w-full px-4 grid grid-cols-2 gap-2 lg:grid-cols-4 lg:my-16 text-center">
                    ...
                    <div class="flex flex-col justify-center items-center gap-2.5 lg:gap-5 border-2 border-zinc-200 p-2.5 lg:px-4 lg:py-6 rounded-lg cursor-pointer hover:border-blue-600 transform transition-all opacity-0 -translate-y-24 ease-out duration-1000 delay-[500ms]" data-replace='{"-translate-y-24":"translate-y-0","opacity-0": "opacity-100","delay-[500ms]":"delay-0" }'>
                        ...
                        <div>
                            ...
                            <p class="leading-relaxed text-xs md:text-base font-medium">Languages Learned</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col justify-center items-center gap-2.5 border-2 border-zinc-200 p-2.5 lg:px-4 lg:py-6 rounded-lg cursor-pointer hover:border-blue-600 transform transition-all opacity-0 -translate-y-24 ease-out duration-1000 delay-[600ms]" data-replace='{"-translate-y-24":"translate-y-0","opacity-0": "opacity-100","delay-[600ms]":"delay-0" }'>
                        ...
                        <div>
                            ...
                            <p class="leading-relaxed text-xs md:text-base font-medium">Software known</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col justify-center items-center gap-2.5 border-2 border-zinc-200 p-2.5 lg:px-4 lg:py-6 rounded-lg cursor-pointer hover:border-blue-600 transform transition-all opacity-0 -translate-y-24 ease-out duration-1000 delay-[700ms]" data-replace='{"-translate-y-24":"translate-y-0","opacity-0": "opacity-100","delay-[700ms]":"delay-0" }'>
                        ...
                        <div>
                            ...
                            <p class="leading-relaxed text-xs md:text-base font-medium">Work Experience</p>
                        </div>
                    </div>
        ...
        <section class="container mx-auto sm:px-6 lg:px-8" id="work">
            ...
            <div class="px-4 w-full grid grid-cols-1 md:grid-cols-2 gap-5">
                <a class="group 3dhover relative flex justify-center items-end w-full min-h-[224px] h-[25vh] lg:h-[40vh] row-span-1 bg-gradient-to-br from-green-600 to-cyan-800 rounded-xl hover:shadow-xl cursor-pointer" data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-gyroscope="false">
                ...
                <a class="group 3dhover relative flex justify-center items-end w-full min-h-[224px] h-[25vh] lg:h-[40vh] row-span-1 bg-gradient-to-br from-blue-400 to-indigo-800 rounded-xl hover:shadow-xl cursor-pointer" data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-gyroscope="false">
                    <div class="absolute top-5 right-5 opacity-0 group-hover:opacity-100 p-2 bg-zinc-800 text-zinc-400 hover:text-blue-600 rounded-full flex justify-center items-center transition-opacity"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg></div>
                ...
                <a class="group 3dhover relative flex justify-center items-end w-full min-h-[224px] h-[25vh] lg:h-[40vh] row-span-1 bg-gradient-to-br from-yellow-400 to-yellow-700 rounded-xl hover:shadow-xl cursor-pointer" data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-gyroscope="false">
                    <div class="absolute top-5 right-5 opacity-0 group-hover:opacity-100 p-2 bg-zinc-800 text-zinc-400 hover:text-blue-600 rounded-full flex justify-center items-center transition-opacity"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg></div>
                ...
                <a class="group 3dhover relative flex justify-center items-end w-full min-h-[224px] h-[25vh] lg:h-[40vh] row-span-1 bg-gradient-to-br from-red-400 to-purple-700 rounded-xl hover:shadow-xl cursor-pointer" data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-gyroscope="false">
                    <div class="absolute top-5 right-5 opacity-0 group-hover:opacity-100 p-2 bg-zinc-800 text-zinc-400 hover:text-blue-600 rounded-full flex justify-center items-center transition-opacity"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg></div>
        ...
        <section id="api" class="container mx-auto px-4 py-6 sm:px-6 lg:px-8 lg:pt-24">
            ...
            <div class="flex flex-col md:flex-row md:gap-2.5 lg:gap-5">
                ...
                <!-- Terminal -->
                <div id="terminal" class="min-h-[350px] h-[45vh] md:h-auto md:w-1/2 lg:w-1/3 p-2.5 bg-zinc-900 text-white rounded-lg grid grid-cols-2 auto-rows-min"></div>
            </div>            
        </section>

        <section id="contact" class="container mx-auto pt-12 px-4 pb-6 sm:px-6 lg:px-8 lg:pt-24">
            <div class="w-full min-h-[560px] h-[60vh] md:h-[70vh] grid grid-cols-1 md:grid-cols-2 grid-rows-3 gap-2.5 md:gap-5">
                <div class="md:col-span-2 md:row-span-2 min-h-[180px] bg-cover bg-center rounded-lg cursor-pointer overflow-hidden group" style="background-image: url('/img/photo-1551970634-747846a548cb.avif');">
                    <div class="w-full h-full flex flex-col justify-evenly md:justify-center items-center md:gap-10 bg-black bg-opacity-60 lg:backdrop-blur-sm lg:group-hover:backdrop-blur-none transition-all duration-500">
                        <div class="text-xl md:text-5xl font-medium text-center text-white">Interested to work together?</div>
                        
                        <a href="https://www.linkedin.com/in/maxime-sickenberg/" target="_blank" class="inline-flex align-middle gap-2 items-center rounded-md border border-transparent bg-blue-600 px-3 py-2 md:px-4 lg:px-6 lg:py-3 text-sm md:text-lg lg:text-xl font-medium leading-4 text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            Send me a message
                        </a>
                    </div>
                </div>
                
                <div class="flex flex-col justify-center items-center gap-2.5 min-h-[180px] p-4 lg:p-5 rounded-lg bg-[#e9e8e4] hover:shadow transition-shadow">
                    <a href="mailto:maxime.sickenberg@gmail.com" class="text-sm md:text-base lg:text-lg text-blue-500 hover:text-blue-700">My e-mail</a>
                    ...
                    <a href="https://www.linkedin.com/in/maxime-sickenberg/" class="text-sm md:text-base lg:text-lg text-blue-500 hover:text-blue-700">My linkedin page</a>
                </div> 
        ...
        <footer class="bg-white">
            <div class="mx-auto max-w-7xl pt-6 pb-12 px-6 lg:flex lg:items-center lg:justify-between lg:px-8">
                <div class="flex justify-center space-x-6 lg:order-2">  
                    <a href="https://github.com/TheRedRacing" class="text-gray-400 hover:text-gray-500 p-2 border-2 border-white hover:border-blue-500 rounded-md">
                    ...
                    <a href="https://www.linkedin.com/in/maxime-sickenberg/" class="text-gray-400 hover:text-gray-500 p-2 border-2 border-white hover:border-blue-500 rounded-md">
                    ...
                    <a href="https://www.instagram.com/makcnmas/" class="text-gray-400 hover:text-gray-500 p-2 border-2 border-white hover:border-blue-500 rounded-md">
            ...
            <div class="fixed inset-0 z-10 overflow-y-auto">
                <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center">
                    <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl sm:p-6">
                        <div class="">
                            <div class="text-lg lg:text-xl font-medium leading-6 text-gray-900 flex justify-between items-center">
                                <div>About me</div>
                            ...
                            <div class="mt-2">
                                <div class="text-gray-600 flex flex-col text-xs lg:text-lg w-full text-justify">
